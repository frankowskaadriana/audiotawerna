...
public class VCA : MonoBehaviour
{
    ...
    [SerializeField]
    private bool sfxMuteActive = false;
    ...
    void Start()
    {
        ...
        tavernVCA = FMODUnity.RuntimeManager.GetVCA("vca:/Tavern-amb");
        outsideVCA = FMODUnity.RuntimeManager.GetVCA("vca:/Outside-amb");
        sfxVCA = FMODUnity.RuntimeManager.GetVCA("vca:/Outside-amb");
